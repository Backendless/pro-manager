...
function getObjectProperty(object, propPath) {
  ...
  ___arguments.context.pageData['saveBtnClicked'] = true;
  isValid = true;
...
function getObjectProperty(object, propPath) {
  ...
  for (var dataItem_index in dataItem_list) {
    ...
    for (var field_index in field_list) {
      field = field_list[field_index];
      if ((getObjectProperty(field, 'validationMsgVisible')) && (getObjectProperty(___arguments.context.pageData, 'saveBtnClicked'))) {
        return true;
      }
    }
  }
