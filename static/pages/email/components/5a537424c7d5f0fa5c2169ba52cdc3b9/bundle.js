...
function getObjectProperty(object, propPath) {
  ...
  ___arguments.context.pageData['saveBtnIsClicked'] = true;
  ...
  try {
    console.log((await BackendlessUI.Functions.Custom['fn_696a14dd8d2f85be7023c2c4441a65a5']('put', '/manage/configuration/mail?restart=false', (((function (componentUid) { return ___arguments.context.getComponentByUid(componentUid).dynamicListItems })('9f186f89932cdfe880554e43f4f916a1'))[0]), null)));
...
function getObjectProperty(object, propPath) {
  ...
  dataContainer = ((function (componentUid) { return ___arguments.context.getComponentByUid(componentUid).dynamicListItems })('9f186f89932cdfe880554e43f4f916a1'))[0];
  if ((getObjectProperty(___arguments.context.pageData, 'saveBtnIsClicked')) && ((getObjectProperty(dataContainer, 'validationMessageTimeout')) || (getObjectProperty(dataContainer, 'validationMessagePassword')) || (getObjectProperty(dataContainer, 'validationMessageSendFrom')) || (getObjectProperty(dataContainer, 'validationMessageFromEmail')) || (getObjectProperty(dataContainer, 'validationMessageSendTimeout')) || (getObjectProperty(dataContainer, 'validationMessageSMTPPort')) || (getObjectProperty(dataContainer, 'validationMessageSMTPHost')) || (getObjectProperty(dataContainer, 'validationMessageUserID')))) {
    return true;
  }

  return (getObjectProperty(___arguments.context.pageData, 'btnSaveDisabled'))
