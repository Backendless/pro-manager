...
function getObjectProperty(object, propPath) {
  ...
  if ((getObjectProperty(___arguments.context.pageData, 'saveBtnIsClicked')) && (await Promise.all(((function (componentUid) { return ___arguments.context.getComponentByUid(componentUid).dynamicListItems })('8df5e86e263721a17d2eb9a2f1451d2c')).map(async item => {; return (getObjectProperty(item, 'validationMsgVisible'));}))).indexOf(true) + 1 > 0) {
    return true;
  }
