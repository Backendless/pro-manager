...
export function start() {
  ...
  const server = app.listen(Config.port, err => {
    ...
    Logger.info('')
    Logger.info('*************************************************************************************')
    Logger.info('***   Backendless.Marketplace is running, talking to API server on %s', Config.apiUrl)
    Logger.info('***   Open http://localhost:%s in a browser to view the app.', Config.port)
    Logger.info('*************************************************************************************')
    Logger.info('')
  })
