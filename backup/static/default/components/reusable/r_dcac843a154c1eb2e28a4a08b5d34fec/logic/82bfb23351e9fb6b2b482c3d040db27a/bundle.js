...
function addItemToList(l, v) { Array.prototype.push.apply(l, Array.isArray(v) ? v : [v]);return l;}
  ...
  if ((getObjectProperty(___arguments.context.pageData, 'pageConfiguration')) == 'domainsGeneral' || (getObjectProperty(___arguments.context.pageData, 'pageConfiguration')) == 'ssl' || (getObjectProperty(___arguments.context.pageData, 'pageConfiguration')) == 'ingress' || (getObjectProperty(___arguments.context.pageData, 'pageConfiguration')) == 'consul') {
    ...
    if (height && getHeight) {
      ((function (componentUid) { return ___arguments.context.getComponentStyleByUid(componentUid) })('82bfb23351e9fb6b2b482c3d040db27a'))['maxHeight'] = getHeight;
