...
function getObjectProperty(object, propPath) {
  ...
  dataContainer = ((function (componentUid) { return ___arguments.context.getComponentByUid(componentUid).dynamicListItems })('9f186f89932cdfe880554e43f4f916a1'))[0];
  if ((getObjectProperty(dataContainer, 'validationMessageTimeout')) || (getObjectProperty(dataContainer, 'validationMessagePassword')) || (getObjectProperty(dataContainer, 'validationMessageSendFrom')) || (getObjectProperty(dataContainer, 'validationMessageFromEmail')) || (getObjectProperty(dataContainer, 'validationMessageSendTimeout')) || (getObjectProperty(dataContainer, 'validationMessageSMTPPort')) || (getObjectProperty(dataContainer, 'validationMessageSMTPHost')) || (getObjectProperty(dataContainer, 'validationMessageUserID'))) {
    return true;
  }
