 ...
 */
async function checkIngressData2() {
  ...
  await BackendlessUI.Functions.Custom['fn_696a14dd8d2f85be7023c2c4441a65a5']('put', '/manage/state', ({ [`serviceName`]: (getObjectProperty(___arguments.context.pageData, 'serviceName')),[`state`]: 'restart',[`hidden`]: false }), null);
  await checkIngressData2();
