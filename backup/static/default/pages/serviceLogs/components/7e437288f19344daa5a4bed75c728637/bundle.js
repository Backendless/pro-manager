...
async function getPodEvents() {
  ___arguments.context.pageData['podEvents'] = (await BackendlessUI.Functions.Custom['fn_696a14dd8d2f85be7023c2c4441a65a5']('get', (String('/k8s/pod/events/') + String(getObjectProperty(___arguments.context.pageData, 'podName'))), null, null));
}


  ___arguments.context.appData['logsTab'] = false;
  if (!(((function (componentUid) { return ___arguments.context.getComponentClassesByUid(componentUid) })('bf4ddcd624beb122ea9990fa10566b0f')).includes('show'))) {
    addItemToList(((function (componentUid) { return ___arguments.context.getComponentClassesByUid(componentUid) })('bf4ddcd624beb122ea9990fa10566b0f')), 'show');
  }
