...
async function getOrigin() {
  ...
  ___arguments.context.getComponentDataStoreByUid('c285fdb7425cfedb989a67dd73e1e756')['createBtnIsClicked'] = true;
  isFormValid = true;
  ...
  return ((getObjectProperty(___arguments.context.getComponentDataStoreByUid('c285fdb7425cfedb989a67dd73e1e756'), 'createBtnDisabled')) || (getObjectProperty(___arguments.context.getComponentDataStoreByUid('c285fdb7425cfedb989a67dd73e1e756'), 'validationMessageName')) || ((getObjectProperty(___arguments.context.getComponentDataStoreByUid('c285fdb7425cfedb989a67dd73e1e756'), 'createBtnIsClicked')) ? !(getObjectProperty(___arguments.context.pageData, 'isInputCtrFile')) || !(getObjectProperty(___arguments.context.pageData, 'isInputKeyFile')) : false))
