...
async function closeModal(message, color) {
  ...
  try {
    ...
    if ((getObjectProperty((getObjectProperty(___arguments.context.getComponentDataStoreByUid('bff4d8ac579f78a648132998464e4919'), 'repeaterItem')), 'type')) == 'consul') {
      ___arguments.context.pageData['consulData'] = null;
    }
