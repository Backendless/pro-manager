define([], () => ({
  ...
  } else if ((getObjectProperty(___arguments.context.dataModel, 'name')) == 'Nothing found') {
    ___arguments.context.pageData['version'] = (getObjectProperty(((function (componentUid) { return ___arguments.context.getComponentByUid(componentUid) })('f0e46aefb9a7b07518bb18eea4713526')), 'value'));
    ___arguments.context.pageData['btnUpgradeDisabled'] = false;
    ((function (componentUid) { return ___arguments.context.getComponentStyleByUid(componentUid) })('d61f05ceb764b89f8c44a8c320457ad6'))['opacity'] = '1';
  } else {
